            ...
            <h1>Transação de Moedas</h1>
              <div className="transaction-form">
                <div className="form-row">
                    ...
                    <input type="text" id="professor" placeholder="Digite seu ID"/>
                </div>
                <div className="form-row">
                    <label htmlFor="aluno">Aluno:</label>
                    <input type="text" id="aluno" placeholder="ID do aluno" />
                </div>
                <div className="form-row">
                    <label htmlFor="quantidade">Quantidade:</label>
                    <input type="number" id="quantidade" placeholder="Quantidade de moedas"/>
                </div>
                <button className="submit-button">Realizar Transação</button>
            </div>
        </div>
